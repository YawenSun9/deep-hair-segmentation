...
curl -O http://vis-www.cs.umass.edu/lfw/part_labels/parts_lfw_funneled_gt_images.tgz

echo "Unzip parts_lfw_funneled_gt_images.tgz ..."
tar -xvf parts_lfw_funneled_gt_images.tgz

echo "Now downloading txt files"
curl -O http://vis-www.cs.umass.edu/lfw/part_labels/parts_train.txt
curl -O http://vis-www.cs.umass.edu/lfw/part_labels/parts_validation.txt
curl -O http://vis-www.cs.umass.edu/lfw/part_labels/parts_test.txt
